...
import { Censo, Evaluadas, envRutas, hoy, launch, openPage, settle, w, APP} from "./lib.mjs";
 ...
 * pueda olvidar. */
const ev = new Evaluadas({ nombre: "c-cabecera", unidad: "páginas (2 por unidad: los dos lados)", minimo: (RUTAS.length) * 2, porPaginas: true });
