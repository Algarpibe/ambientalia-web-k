...
export const CASOS_PUBLICADOS: CasoDeExito[] = [
  {
    ...
    fechaPublicacion: "2024-09-30T14:59:58+02:00",
  ...
  },
  {
    ...
    /* ISO del JSON-LD del singular, transcrito del corpus. Ver el tipo. */
    fechaPublicacion: "2019-05-07T14:06:33+02:00",
    // Banda de cabecera (C-QA1): `min-height` 387 es plantilla en las 4;
    // la foto cambia en las 4 → campo. Medida en `medidas/c-banda-1440.json`.
  ...
  },
  {
    ...
    /* ISO del JSON-LD del singular, transcrito del corpus. Ver el tipo. */
    fechaPublicacion: "2026-01-30T11:57:23+02:00",
    // Banda de cabecera (C-QA1): `min-height` 387 es plantilla en las 4;
    // la foto cambia en las 4 → campo. Medida en `medidas/c-banda-1440.json`.
  ...
  },
  {
    ...
    /* ISO del JSON-LD del singular, transcrito del corpus. Ver el tipo. */
    fechaPublicacion: "2018-06-08T16:27:06+02:00",
    // Banda de cabecera (C-QA1): `min-height` 387 es plantilla en las 4;
    // la foto cambia en las 4 → campo. Medida en `medidas/c-banda-1440.json`.
