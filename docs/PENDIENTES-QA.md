...
> Alturas de referencia (2026-07-23, tras M2+M3): original desktop **11863px** /
> clon **11848px** (−15); original móvil **19221px** / clon **19377px** (+156 —
> prácticamente todo es el hero M1, +167; sectores M3 ya exacto).
...
|---|---------|-------------|----------|
| M1 | Hero (móvil 390px) | Clon 1031px vs original 836px. **H2 titular ya bajado a 38px móvil (2026-07-23)**; queda **pendiente compactar la fila de badges EPA/MCERTS/AIRLAB** (en el original apilan más juntos) y revisar el resto del ritmo móvil del hero. Tras M2+M3 es **el único delta móvil grande restante** (+167; página 19377 vs 19221). | +167px solo móvil (parcial) |
