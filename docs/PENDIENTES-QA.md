...
> Alturas de referencia (2026-07-23, tras M2): original desktop **11863px** /
> clon **11848px** (−15); original móvil **19221px** / clon **19221px** (0 —
> el +167 del hero M1 compensa el −156 de sectores M3; ambos siguen abiertos).
...
| M3 | S3 Sectores intro (móvil) | Clon 809px vs original 965px (re-medido tras M2; antes 825). Desktop ya cuadra (−13px); en móvil el original escala títulos/espaciados distinto. | −156px solo móvil |
