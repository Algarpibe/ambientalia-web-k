// 127.ª · CIERRE — BARRIDO DE §regla 12, ACOTADO
//
...
const ALCANCE = [
  ...
  { fichero: "docs/ESQUEMA-CMS.md", desde: /^## ⚠⚠ §2o\.3 · /m, hasta: /^## §2o\.4 · /m, razon: "la sección que esta tanda reescribió entera" },
  { fichero: "docs/PENDIENTES-QA.md", desde: /^## 2026-08-31 · 127\.ª/m, razon: "el acta de esta tanda" },
];
...
const salida = {
  meta: {
    tanda: "127.ª · CIERRE — barrido §regla 12",
  ...
  adjudicacionAMano: [
    { enunciado: "Comparar CONJUNTOS de valores entre instancias confunde…", disposicion: "REGLA · promovida", destino: "CLAUDE.md §regla 41" },
    { enunciado: "Se ficha como CLASE: `payload migrate:create` emite el `DROP CONSTRAINT`…", disposicion: "REGLA · promovida", destino: "CLAUDE.md §regla 42" },
    { enunciado: "Y la cascada se toma a LOS DOS ANCHOS", disposicion: "REGLA · promovida como MITAD que faltaba", destino: "CLAUDE.md §regla 35, rider" },
    { enunciado: "Y LOS 40 QUE QUEDAN NO SON «PLANTILLA»: SON `SIN ESCRIBIR`…", disposicion: "EVENTO · se queda", destino: "su regla general ya está en CLAUDE.md (§*el test A supone que hay algo escrito*); lo que aquí es nuevo es el CARDINAL 40, que lleva fecha y ruta" },
  ],
...
writeFileSync("docs/research/cola-larga/derivaciones/regla12-barrido-127.json", JSON.stringify(salida, null, 2) + "\n", "utf8");
...
writeFileSync("docs/research/cola-larga/derivaciones/regla12-barrido-127.log", L.join("\n") + "\n", "utf8");
