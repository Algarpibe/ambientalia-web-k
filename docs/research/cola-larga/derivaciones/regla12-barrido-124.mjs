// 124.ª · BARRIDO DE §regla 12, ACOTADO — ¿que enunciados con FORMA DE REGLA
...
const salida = {
  meta: { tanda: "124.ª · CIERRE — barrido §regla 12", fecha: new Date().toISOString().slice(0, 10), alcance: ALCANCE.map((a) => `${a.fichero} (${a.razon})`), noContesta: ["el archivo entero: el barrido es ACOTADO por diseño, y eso es una limitación declarada, no un descuido"] },
  controles,
...
writeFileSync("docs/research/cola-larga/derivaciones/regla12-barrido-124.json", JSON.stringify(salida, null, 2) + "\n", "utf8");
