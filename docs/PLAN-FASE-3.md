...
| **F3-5** · los content types de lo ya construido | 🔶 **PRIMERA MITAD HECHA (126.ª, 2026-08-31): el content type ESCRITO** para **4 de las 5 rutas** —colección `arquetipos`, ESQUEMA §2o, con sus **46 SIN PROBAR declarados y no cableados**—. **Falta la segunda mitad**, que es lo que cierra la fase: **0 filas sembradas · 0 lectores en el render**, o sea que las 4 rutas siguen sirviéndose de `src/lib/`. **HOME queda fuera** por alcance del encargo, no por criterio. Lo abierto, con su cardinal, en `PENDIENTES-QA.md` §126.ª. Alcance original (81.ª): **5 rutas · 4 arquetipos + 1 variante**; la lectura «content type de HOME» sigue borrada |
